#!/bin/bash
# InstaSpam v1.0
# github.com/Mrxxzzzz/instaspam
# Author: @F4ncyb3r S0l0 T34m(You don't become a coder by just changing the credits)
...
printf "                                 | |                     \n"
printf "                                 |_|\e[0m\e[1;92mv1.0 @F4NCYBER S0L0 T34M\e[0m                     \n"
printf "\n"
